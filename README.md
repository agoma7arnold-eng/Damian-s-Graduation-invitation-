...
<head>
    ...
    <title>Damian's Graduation Celebration</title>
...
<body class="bg-pattern min-h-screen flex items-center justify-center p-4 py-12">
    ...
    <div class="bg-white rounded-3xl shadow-2xl max-w-md w-full relative overflow-hidden transform transition-all hover:scale-[1.01] duration-300">
        ...
        <div class="relative z-10 px-8 pb-8 pt-12 flex flex-col items-center text-center">
            ...
            <h2 class="text-sm font-semibold tracking-widest text-gray-400 uppercase mb-2">You're Invited to Celebrate</h2>
            <h1 class="text-5xl font-serif text-gray-800 mb-2">Damian's</h1>
            <h2 class="text-3xl font-serif text-yellow-600 italic mb-6">Graduation</h2>

            <!-- Photo Section -->
            <div class="mb-6 relative">
                <!-- Ensure "23222.jpg" is in the same folder as this file -->
                <img src="23222.jpg" alt="Chef Damian" class="w-48 h-48 rounded-full object-cover border-4 border-yellow-400 shadow-md mx-auto">
            </div>

            <div class="w-16 h-1 bg-yellow-400 rounded mb-6"></div>

            <p class="text-gray-600 mb-6 leading-relaxed">
                Join us in celebrating this special milestone! Damian has conquered his training, and we couldn't be more proud.
            </p>

            <!-- Video Section -->
            <div class="w-full mb-8 rounded-xl overflow-hidden shadow-md bg-gray-100 border border-gray-200">
                <video controls class="w-full aspect-video object-cover">
                    <!-- Replace this with your video file name, e.g., "cooking-video.mp4" -->
            ...
            <div class="w-full bg-gray-50 rounded-xl p-4 mb-8 text-sm text-gray-600 border border-gray-100">
                ...
                <p>Click the button below to send a congratulatory text directly via WhatsApp.</p>
            </div>
    ...
    <script>
        ...
        function sendWhatsApp() {
            ...
            const message = "Congratulations Damian🎉🙏🥂"; 
